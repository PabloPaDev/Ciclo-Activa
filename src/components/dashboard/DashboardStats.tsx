	...
	return (
		<section className="grid grid-cols-2 gap-3 lg:grid-cols-4">
			<article className={statCardClass}>
				<p className="text-[10px] font-semibold uppercase tracking-[0.1em] text-[#5F6B6D]">Atletas activas</p>
				<p className="mt-1.5 text-2xl font-bold tracking-tight text-[#0F2D2F]">{totalAthletes}</p>
			</article>
			<article className={statCardClass}>
				<p className="text-[10px] font-semibold uppercase tracking-[0.1em] text-[#5F6B6D]">Alertas altas</p>
				<p className="mt-1.5 text-2xl font-bold tracking-tight text-[#C96B5C]">{highAlerts}</p>
			</article>
			<article className={statCardClass}>
				<p className="text-[10px] font-semibold uppercase tracking-[0.1em] text-[#5F6B6D]">En precaución</p>
				<p className="mt-1.5 text-2xl font-bold tracking-tight text-[#D9A441]">{yellowCount}</p>
			</article>
			<article className={statCardClass}>
				<p className="text-[10px] font-semibold uppercase tracking-[0.1em] text-[#5F6B6D]">En riesgo alto</p>
