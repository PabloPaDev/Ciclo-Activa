-- RLS mínima: un coach autenticado puede crear perfiles con rol athlete, filas en athletes
-- vinculadas a ese perfil y coach_athletes para su propio coach_id.
-- Ejecutar en Supabase SQL Editor si aún no aplicaste la migración equivalente.
